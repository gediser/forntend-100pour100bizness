<template>
    ...
    >
        ...
        <div v-if="publique=='admin'" class="mt-3">
            <button v-if="product.activate || parseInt(product.activate) > 0" @click="emit('desactivate', product)" class="flex py-2 px-4 border border-transparent text-sm rounded-md text-white bg-red-600 hover:bg-red-700 focus:ring-2 focus:ring-offset-2 focus:ring-red-500">D&eacute;sactiver</button>
